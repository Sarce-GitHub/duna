...
namespace X3_TERMINALINI.ricevimento
{
    public partial class Ricevimento : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var x = _SQL.Obj_YTSRICAPE_FilterByFornitore("000636");
        }
        ...
        protected void txtAutoCodiceFornitore_TextChanged(object sender, EventArgs e)
        {
            

            foreach (var item in _SQL.Obj_YTSORDAPE_Indirizzi(_USR.FCY_0, txtAutoCodiceFornitore.Text, false))
            {
            ...
            //foreach (var item in _SQL.Obj_YTSORDAPE_Date(_USR.FCY_0, txtAutoCodiceFornitore.Text, ddl_BPAADD.SelectedValue, false))
            //{
        ...
        {
            //Response.Redirect("Ordine_Righe.aspx?BC=" + txtAutoCodiceFornitore.Text + "|" + ddl_BPAADD.SelectedValue + "|" + ddl_SHIDAT_DA.SelectedValue + "|" + ddl_SHIDAT_A.SelectedValue, true);
        }
