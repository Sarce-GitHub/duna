...
{
    public partial class Ordine_Spedizione : System.Web.UI.Page
    {
        ...
        protected void btn_RicercaBC_Click(object sender, EventArgs e)
        {
            ...
            if (isOrdine)
            {
                ...
                Response.Redirect("Ordine_Spedizione_Righe.aspx?BC=" + bc, true);
                return;
            }
            ...
            {
                Response.Redirect("Ordine_Spedizione_Righe.aspx?BC=" + txt_RicercaBC.Text.Trim().ToUpper(), true);
                return;
            }
            else
            {
        ...
        protected void btn_Conferma_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("Ordine_Spedizione_Righe.aspx?BC=" + txtAutoCodiceClienteSped.Text + "|" + ddl_BPAADD.SelectedValue + "|" + ddl_DATA_DA.SelectedValue + "|" + ddl_DATA_A.SelectedValue, true);
            }
        }
