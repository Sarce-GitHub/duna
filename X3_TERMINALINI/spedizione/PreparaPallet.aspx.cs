...
{
    public partial class PreparaPallet : System.Web.UI.Page
    {
        ...
        {
            if (!_SQL.obj_PALNUM_Check(_USR.FCY_0, txt_etichetta.Text))
            {
                div_new.Visible = true;
                lbl_NewPallet.Text = "Pallet <b>" + txt_etichetta.Text + "</b> non censito a magazzino.<br/>Inserire una ubicazione di destinazione e confermare.";
            ...
            if (_SQL.obj_PALNUM_PRESPED_Check(_USR.FCY_0, txt_etichetta.Text))
            {
                //PALLET VERIFICATA
                string _s = "";
                string _loc = "";
                ...
                txt_ubicazione.Text = _loc;
                txt_ubicazione.Enabled = false;
                div_ubicazione_pallet.Visible = true;
                txt_articolo.Focus();
            }
            else
            {
                frm_error.Text = "Pallet " + txt_etichetta.Text + " non di prespedizione";
                txt_etichetta.Text = "";
                txt_etichetta.Focus();
            }
        }
        ...
        protected void btt_Nuovo_Conferma_Click(object sender, EventArgs e)
        {
            ...
            //
            if (!_SQL.obj_STOLOC_Presped_Check(_USR.FCY_0, txt_destinazione.Text))
            {
                frm_error.Text = "Ubicazione " + txt_destinazione.Text + " in " + _USR.FCY_0 + " non censita o non di prespedizione";
        ...
        {
            Response.Redirect("PreparaPallet.aspx");
        }

        protected void btt_Esegui_Click(object sender, EventArgs e)
        {
            if (!Check_Esegui()) return;
            if (RunCambioStock(_s)) Response.Redirect("PreparaPallet.aspx");
        }
        ...
        private bool Check_Esegui()
        {
            ...
            {
                frm_error.Text = "Ubicazione " + txt_ubicazione.Text + " non censita in " + _USR.FCY_0;
                txt_ubicazione.Text = "";
        ...
        protected void Ricerca()
        {
            ...
            //txt_Quantita.Text = _s.QTYSTU_0.ToString("0.####");
            //lbl_Qta.Text = "Qta prelevabile: " + _s.QTYSTU_0.ToString("0.####");
            //txt_Quantita.Focus();
        }
