...
{
    public partial class DisassemblaPallet : System.Web.UI.Page
    {
        ...
        protected void txt_etichetta_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                frm_error.Text = "Pallet " + txt_etichetta.Text.Trim().ToUpper() + " non censito in " + _USR.FCY_0;
                txt_etichetta.Text = "";
                txt_etichetta.Focus();
                return;
            }

            var stockList = _SQL.obj_STOCK_SearchByPalnum(_USR.FCY_0, txt_etichetta.Text.Trim().ToUpper()).OrderBy(o => o.ITMREF_0).ThenBy(o => o.LOT_0);
        ...
        private void RunCambioStock()
        {
            ...
            foreach (Obj_STOCK _stock in _SQL.obj_STOCK_SearchByPalnum(_USR.FCY_0, txt_etichetta.Text))
            {
                ...
                src_Data.Add(new Xml_Data("IN_PALNUM_D", "", ""));
            ...
            if (ok)
            {
                //CANCELLARE PALLET DA YTSPREPORD
                _SQL.Obj_YTSPREPORD_Del_PALNUM(txt_etichetta.Text.ToUpper().Trim());
                //
