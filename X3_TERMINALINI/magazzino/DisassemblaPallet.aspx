<%@ Page Title="" Language="C#" MasterPageFile="~/_include/Menu.Master" AutoEventWireup="true" CodeBehind="DisassemblaPallet.aspx.cs" Inherits="X3_TERMINALINI.magazzino.DisassemblaPallet" %>
<asp:Content ID="Content1" ContentPlaceHolderID="CPH_head" runat="server">

</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Main" runat="server">
     <h4>Disassemblaggio Pallet</h4>
