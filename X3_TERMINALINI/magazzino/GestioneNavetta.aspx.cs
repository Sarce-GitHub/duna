...
{
    public partial class GestioneNavetta : System.Web.UI.Page
    {
        // Variabili generali
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (CARICO)
            {
                ...
                lbl_title.Text = "Carico Navetta";
                lbl_Destinazione.Text = "Navetta da Caricare";
                lbl_Destinazione_SC.Text = "Navetta da Caricare";
            ...
            else
            {
                ...
                lbl_title.Text = "Scarico Navetta";
        ...
        protected void txt_navetta_da_scaricare_TextChanged(object sender, EventArgs e)
        {
            ...
            if (!_SQL.obj_STOLOC_Navetta_Check(_USR.FCY_0, txt_navetta_da_scaricare.Text.Trim().ToUpper()))
            {
                //UBICAZIONE VERIFICATA
                txt_navetta_da_scaricare.Text = "";
                //txt_navetta_da_scaricare_SC.Text = "";
                txt_navetta_da_scaricare.Focus();
                frm_error.Text = "Inserita Navetta Inesistente";
            }
            else
            {                 
        ...
        protected void txt_Partenza_TextChanged(object sender, EventArgs e)
        {
            ...
            if (_SQL.obj_PALNUM_Check(_USR.FCY_0, txt_Partenza.Text.Trim().ToUpper()))
            {
                ...
                {
                    //CHECK PALLET GIA' PRESENTE SU NAVETTA
                    if (CARICO && item.LOC_0 == txt_Destinazione.Text.Trim().ToUpper())
                    {
                        frm_error.Text = "Pallet già presente su navetta";
                        lbl_Articolo.Text = "";
                        txt_Partenza.Text = "";
                        txt_Partenza.Focus();
                        return;
                    ...
                    {                           
                        frm_error.Text = "Pallet non presente su Navetta";
                        lbl_Articolo.Text = "";
                        txt_Partenza.Text = "";
                        txt_Partenza.Focus();
                        return;
        ...
        protected void txt_Destinazione_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                //CHECK UBICAZIONE
                if (CARICO ? _SQL.obj_STOLOC_Navetta_Check(_USR.FCY_0, txt_Destinazione.Text.Trim().ToUpper()) : _SQL.obj_STOLOC_Check(_USR.FCY_0, txt_Destinazione.Text.Trim().ToUpper()))
                {
                    //UBICAZIONE VERIFICATA
                ...
                if (HF_Tipo_D.Value == "")
                {
                    frm_error.Text = CARICO ? "Inserita Navetta Inesistente" : "Inserita Ubicazione Inesistente";
                    txt_Destinazione.Text = "";
                    txt_Destinazione.Focus();
                }
            }
        ...
        private void RunCambioStock()
        {
            ...
            if (txt_Destinazione.Text.Trim() == "")
            {
                frm_error.Text = CARICO ? "Navetta non inserita" : "Destinazione non Inserita";
                return;
            }
            //
        ...
        protected void txt_Destinazione_SC_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                //CHECK UBICAZIONE
                if (CARICO ? _SQL.obj_STOLOC_Navetta_Check(_USR.FCY_0, txt_Destinazione_SC.Text.Trim().ToUpper()) : _SQL.obj_STOLOC_Check(_USR.FCY_0, txt_Destinazione_SC.Text.Trim().ToUpper()))
                {
                    //UBICAZIONE VERIFICATA
        ...
        protected void txt_Partenza_SC_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                //CHECK UBICAZIONE
                if (CARICO ? _SQL.obj_STOLOC_Check(_USR.FCY_0, txt_Partenza_SC.Text.Trim().ToUpper()) : _SQL.obj_STOLOC_Navetta_Check(_USR.FCY_0, txt_Partenza_SC.Text.Trim().ToUpper()))
                {
                    //UBICAZIONE VERIFICATA
                ...
                if (HF_Tipo_P.Value == "")
                {
                    frm_error.Text = CARICO ? "Ubicazione/Pallet non trovato" : "Inserita Navetta Inesistente";
                    if(!CARICO) 
                    {
                        txt_Etichetta_SC.Text = "";
                        lbl_Articolo.Text = "";
        ...
        private void RunCambioStockSC()
        {
            ...
            if (txt_Destinazione_SC.Text.Trim() != "")
            {
                ...
                else
                {
                    ...
                    if(CARICO)
                    {
                        HF_Tipo_P.Value = ""; //DA NON RESETTARE PER LO SCARICO, DOVE CORRISPONDE SEMPRE ALLA STESSA NAVETTA
                        txt_Partenza_SC.Text = "";
                        txt_Partenza_SC.Focus();
                    }
                    else
