<%@ Page Title="" Language="C#" MasterPageFile="~/_include/Menu.Master" AutoEventWireup="true" CodeBehind="GestioneNavetta.aspx.cs" Inherits="X3_TERMINALINI.magazzino.GestioneNavetta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Main" runat="server">
    ...
    <div runat="server" id="CaricaScatole" visible="false">
        <div runat="server" id="div_data">
            ...
            <div class="row">
                <div class="col-12">
                    <span class="font-small"><i>Dati Navetta</i></span><br />
                    <asp:Label runat="server" ID="lbl_Dati_Navetta" CssClass="form-control base-label font-small" value="*"></asp:Label>
                </div>
            </div>
        </div>
    </div>
