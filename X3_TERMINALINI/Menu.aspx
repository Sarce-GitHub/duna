...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_Main" runat="server">
    ...
    <div class="container">
        <div class="row" runat="server" id="nav_general" style="margin-bottom: 30px">
            ...
            <div class="col-12 col-md-4 margin-row-top" runat="server" id="div_btt_gen_Produzione">
                <asp:Button runat="server" ID="btt_gen_Produzione" CssClass="form-control btn btn-ok modal-check" Text="Produzione" PostBackUrl="Menu.aspx?PROD" UseSubmitBehavior="false" />
            </div>
        ...
        <div runat="server" id="nav_stock" style="margin-bottom: 30px">
            ...
            <div class="row">
                ...
                <div runat="server" class="col-12 col-md-4 margin-row-top" ID="div_btn_GS_UbicazionePallet">
            ...
            <div runat="server" class="row" ID="nav_Ass_Diss_Pallet">
                <div class="col-12 col-md-4 margin-row-top">
        ...
        <div class="row" runat="server" id="nav_produzione" style="margin-bottom:30px">
            <div class="col-12"><b>GESTIONE OPERAZIONI DI PRODUZIONE</b></div>
            <div class="col-12 col-md-4 margin-row-top" runat="server" id="div_btn_Avanzamento_Completo">
                <asp:Button runat="server" ID="btn_Avanzamento_Completo" CssClass="form-control btn btn-secondary modal-check" Text="Avanzamento Completo" PostBackUrl="~/produzione/Avanzamento_Completo.aspx" UseSubmitBehavior="false"/>
            </div>
            <div class="col-12 col-md-4 margin-row-top" runat="server" id="div_btn_Consumo_Materiali">
                <asp:Button runat="server" ID="btn_Consumo_Materiali" CssClass="form-control btn btn-primary modal-check" Text="Consumo Materiali" PostBackUrl="~/produzione/Consumo_Materiali.aspx" UseSubmitBehavior="false"/>
            </div>
